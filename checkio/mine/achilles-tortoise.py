"""
n a race, the quickest runner can never overtake the slowest, since the pursuer must first reach the point whence the pursued started, so that the slower must always hold a lead.
...
!()[https://d17mnqrx9pmt3e.cloudfront.net/media/missions/media/97e1976f421343b3ba553161b44a63e2/A1-T2.png]
...
def chase(a1_speed, t2_speed, advantage):
    return (advantage / (a1_speed - t2_speed)) * a1_speed
