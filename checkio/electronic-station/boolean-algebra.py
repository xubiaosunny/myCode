...
def boolean(x, y, operation):
    func_map = {
        OPERATION_NAMES[0]: lambda x,y: x and y,
        OPERATION_NAMES[1]: lambda x,y: x or y,
        OPERATION_NAMES[2]: lambda x,y: y if x else 1,
        OPERATION_NAMES[3]: lambda x,y: x != y,
        OPERATION_NAMES[4]: lambda x,y: x == y,
    }
    return func_map[operation](x, y)
